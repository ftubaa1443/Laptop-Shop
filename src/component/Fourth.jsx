  ...
  return (
    <div>
      <div className="mt-[50px]">
        <div className="ml-[530px] text-4xl font-bold">
          Ready to take a Free Trial ?
        </div>
        <div className="ml-[250px] ">
          <div className="ml-[150px] mt-[20px] text-2xl">
            Lorem ipsum dolor sit amet consectetur adipisicing elit tempore
            excepturi
          </div>
          <div className="ml-[220px] text-2xl">
            omnis quae optio commodi veritatis non voluptatum!
          </div>
        </div>
      </div>
      <div className="mt-[30px] h-[400px] ml-[500px]">
        <div className="h-[400px] w-[600px] border-2 pl-[60px] border-black ">
          <div className="gap-5">
            <div className=" mt-[40px] text-2xl font-bold">
              SignUp For Free Account
            </div>

            <div className=" mt-[20px] flex gap-5 ">
              <div className="h-[40px] border-2 text-center w-[200px]">
                FirstNAme
              </div>
              <div className="h-[40px] border-2 text-center w-[200px]">
                Last NAme
            ...
            <div className="h-[40px] w-[420px] mt-[10px] border-2 text-center">
              Create Password
            </div>
            <div className="mt-[20px] rounded bg-cyan-400 text-white text-center w-[100px] h-[30px]">
              <button>SignUp</button>
            </div>
          </div>
        </div>
      </div>
      <div className="h-[160px] bg-black mt-[60px]">
        <div className="flex pl-[70px] pt-[20px]">
          ...
          <div className="text-white ml-[500px]">
            <div className="font-bold">Mobile App </div>
            <div className="pt-[10px]">Live</div>
            <div>Share</div>
            <div>Video</div>
          </div>
          <div className="text-white ml-[100px]">
            <div className="font-bold">Features</div>
            <div className="pt-[10px]">Record</div>
            <div>Community</div>
            <div>Organization</div>
          </div>
          <div className="text-white ml-[100px]">
            <div className="font-bold">Company</div>
            <div className="pt-[10px]">About us</div>
            <div>Contact</div>
            <div>History</div>
          </div>
          <div className="ml-[220px]">
            <div className="border-2 rounded bg-white text-cyan-500 border-b-cyan-500 text-center justify-center w-[100px] h-[40px]">
              <button>Login</button>
            </div>
            <div className=" mt-[15px] rounded bg-cyan-400 text-white text-center w-[100px] h-[40px]">
              <button>SignUp</button>
            </div>
          </div>
        </div>
